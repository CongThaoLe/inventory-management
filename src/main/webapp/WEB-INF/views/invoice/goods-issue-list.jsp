            ...
            <div class="row" style="display: block;">
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <a href='<c:url value="/goods-issue/add"></c:url>' class="btn btn-app"><i class="fa fa-plus"></i>Add</a>
                    <a href='<c:url value="/goods-issue/export"></c:url>' class="btn btn-app"><i class="fa fa-cloud-download"></i>Export to excel</a>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <c:choose>
                            ...
                            <td class="text-center"><a href='<c:url value="/goods-issue/view/${invoice.id}"></c:url>' class="btn btn-round btn-info">View</a>
                            </td>
                            <td class="text-center"><a href='<c:url value="/goods-issue/edit/${invoice.id}"></c:url>' class="btn btn-round btn-primary">Edit</a>
                            </td>
